...
busSys.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@localhost/busTrackingSystem'
...
def addRouteDetails():
    try:
        ...
        print("Parsed times:", start_time_format, end_time_format)
        ...
        new_route = Route(
            ...
            stops=data["stops"]  # Watch this closely
        )
...
def addDriverDetails():
    data = request.json
    dateformat = datetime.strptime(data["date"], "%d/%m/%Y").date()
